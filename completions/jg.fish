...
complete --command jg --exclusive --condition __fish_use_subcommand --arguments cc --description "Generates a Conventional Commit Message from a Jira Issue ID/Key"
